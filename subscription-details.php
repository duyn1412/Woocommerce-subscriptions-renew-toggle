...
<table class="shop_table subscription_details">
	<tbody>
		...
		$dates_to_display = apply_filters( 'wcs_subscription_details_table_dates_to_display', array(
			...
			'last_order_date_created' => _x( 'Last kit processed', 'customer subscription table header', 'woocommerce-subscriptions' ),
			'next_payment'            => _x( 'Processing next kit', 'customer subscription table header', 'woocommerce-subscriptions' ),
		...
		?>
		<?php //var_dump($subscription->get_total()); ?>
		<?php if ( check_renew_toggle( $subscription ) ) : ?>
